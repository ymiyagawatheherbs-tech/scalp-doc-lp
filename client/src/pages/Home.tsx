...
function ScrollProgressBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[60] h-0.5 bg-transparent">
      <div
        className="h-full bg-gradient-to-r from-[oklch(0.42_0.055_130)] to-[oklch(0.82_0.045_130)] transition-all duration-100"
    ...
    <>
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled
            ? "bg-[oklch(0.975_0.018_100/0.97)] backdrop-blur-md shadow-sm border-b border-[oklch(0.88_0.020_130)]"
            : "bg-transparent"
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4 flex items-center justify-between gap-4">
          ...
          <a href="/" className="flex items-center gap-2.5 flex-shrink-0">
            ...
            <div className="flex flex-col leading-none">
              ...
              style={{
                fontSize: "0.75rem",
                color: scrolled ? "oklch(0.35 0.050 130)" : "rgba(255,255,255,0.95)",
              ...
              <span
                ...
                style={{
                  fontSize: "0.6rem",
                  letterSpacing: "0.2em",
                  color: scrolled ? "oklch(0.48 0.08 140)" : "rgba(255,255,255,0.55)",
                }}
              >
                SCALP LABO
              </span>
          ...
          <div className="hidden md:flex flex-col items-center flex-1 justify-center">
            <span
              ...
              style={{
                ...
                color: scrolled ? "oklch(0.48 0.06 140)" : "rgba(255,255,255,0.45)",
            ...
            <span
              className="font-cormorant font-semibold transition-colors"
                ...
                color: scrolled ? "oklch(0.35 0.050 130)" : "rgba(255,255,255,0.75)",
                textTransform: "uppercase",
              }}
            >
              THE HERBS
          ...
          <div className="hidden md:flex items-center gap-6 flex-shrink-0">
            {navLinks.map((item) => (
              <a
                key={item.label}
                href={item.href}
                className={`font-sans-jp text-sm transition-colors hover:text-[oklch(0.45_0.055_130)] ${
                  scrolled ? "text-[oklch(0.35_0.050_130)]" : "text-white/80"
                }`}
              >
                {item.label}
              </a>
          ...
          <div className="md:hidden flex items-center gap-2">
            ...
            >
              <span className={`block w-5 h-0.5 transition-all duration-300 ${
                scrolled ? "bg-[oklch(0.28_0.045_130)]" : "bg-white"
        ...
        <div className={`md:hidden transition-all duration-300 overflow-hidden ${
          ...
          <div className="bg-[oklch(0.975_0.018_100/0.98)] backdrop-blur-md border-t border-[oklch(0.88_0.020_130)] px-6 py-6 space-y-4">
            {navLinks.map((item) => (
              <a
                key={item.label}
                href={item.href}
                onClick={() => setMobileOpen(false)}
                className="block font-sans-jp text-[oklch(0.28_0.045_130)] text-base py-2 border-b border-[oklch(0.88_0.020_130)] hover:text-[oklch(0.45_0.055_130)] transition-colors"
              >
                {item.label}
              </a>
            ))}
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[oklch(0.32_0.045_130/0.52)] via-[oklch(0.32_0.045_130/0.22)] to-transparent" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-6 pt-24 pb-16 md:py-32">
        <div className="max-w-2xl">
          <div className="hidden md:block animate-fade-in-up opacity-0-init">
            <span className="font-cormorant text-[oklch(0.88_0.035_130)] text-sm tracking-[0.3em] uppercase block mb-6">
          ...
          <h1 className="font-mincho text-white leading-tight mb-4 md:mb-6 animate-fade-in-up opacity-0-init delay-100">
            ...
            <span className="block text-2xl md:text-5xl lg:text-6xl font-bold text-[oklch(0.90_0.030_130)]">
              頭皮も定期チェックを。
            </span>
          </h1>
          <p className="hidden md:block font-sans-jp text-white/80 text-base md:text-lg leading-relaxed mb-10 animate-fade-in-up opacity-0-init delay-200">
            ...
            薄毛になってから悩むのではなく、健康な頭皮を<strong className="text-[oklch(0.88_0.035_130)]">意識的にケアする</strong>新習慣。
          </p>
          <p className="md:hidden font-sans-jp text-white/75 text-sm leading-relaxed mb-7 animate-fade-in-up opacity-0-init delay-200">
            マイクロスコープで頭皮の今を記録。<br />
            <strong className="text-[oklch(0.88_0.035_130)]">意識的にケアする</strong>新習慣。
          </p>
          ...
          <div className="mt-8 md:mt-12 flex items-center gap-4 md:gap-6 animate-fade-in-up opacity-0-init delay-400">
            <div className="flex -space-x-2">
              {["A", "B", "C", "D"].map((l) => (
                <div
                  key={l}
                  className="w-7 h-7 md:w-9 md:h-9 rounded-full bg-[oklch(0.69_0.060_130)] border-2 border-white flex items-center justify-center"
                >
...
function ProblemSection() {
  ...
  return (
    <section className="py-24 bg-[oklch(0.25_0.040_130)]" id="問題">
      <div ref={ref} className="max-w-7xl mx-auto px-6">
        <div className={`text-center mb-16 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <h2 className="font-mincho text-white text-3xl md:text-4xl font-bold mb-6">
            ...
            <span className="text-[oklch(0.82_0.07_130)]">最後のチェックはいつですか？</span>
          </h2>
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6">
        ...
        <div className={`text-center mb-14 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <h2 className="font-mincho text-white text-3xl md:text-4xl font-bold mb-4">
            あなたの頭皮は、<br />
            <span className="text-[oklch(0.82_0.07_130)]">どの状態に近いですか？</span>
          </h2>
          ...
          <div>
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="font-cormorant italic text-[oklch(0.72_0.1_130)] text-sm tracking-widest">
              ...
              {SCALP_STATES.map((s, i) => (
                <button
                  ...
                  className={`relative overflow-hidden rounded-sm transition-all duration-300 ${
                    active === i ? "ring-2 ring-[oklch(0.69_0.060_130)] opacity-100" : "opacity-50 hover:opacity-80"
                  }`}
                  style={{ aspectRatio: "1" }}
                  aria-label={s.label}
                >
                  ...
                  {active === i && (
                    <div className="absolute inset-0 bg-[oklch(0.69_0.060_130)]/10" />
                  )}
                </button>
              ))}
            </div>
            ...
            <div className="border border-white/10 rounded-sm p-5 bg-white/5">
              <p className="font-sans-jp text-white/90 text-sm leading-relaxed mb-4">
                <span className="text-[oklch(0.82_0.07_130)] font-bold">あなたの頭皮は今、どんな状態？</span><br />
              ...
              <button
                ...
                style={{ backgroundColor: "oklch(0.42 0.055 130)", color: "#fff" }}
              >
                無料スカルプチェックを予約する
              </button>
            </div>
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className={`transition-all duration-800 ${inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}>
            ...
            <h2 className="font-mincho text-[oklch(0.30_0.045_130)] text-3xl md:text-4xl font-bold leading-tight mb-8">
              「歯科の定期検診」のように、<br />
              <span className="text-[oklch(0.42_0.055_130)]">頭皮ケアの新習慣</span>を広めたい。
            </h2>
            <div className="section-divider mb-8" />
            <div className="space-y-6">
              <div className="karte-border">
                <p className="font-sans-jp text-[oklch(0.35_0.050_130)] text-sm leading-relaxed">
                  かつて歯科検診は「虫歯になってから行く場所」でした。今は「予防のために定期的に通う場所」として定着しています。
                </p>
              </div>
              <div className="karte-border">
                <p className="font-sans-jp text-[oklch(0.35_0.050_130)] text-sm leading-relaxed font-semibold">
          ...
          <div className={`relative transition-all duration-800 delay-200 ${inView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}>
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-[oklch(0.25_0.040_130)] text-white p-6 rounded-sm shadow-xl max-w-xs">
              ...
              <div className="absolute -top-6 -left-6 w-28 h-28 overflow-hidden rounded-sm shadow-xl border-2 border-[oklch(0.69_0.060_130)]">
...
function HabitValueSection() {
  ...
  return (
    <section className="py-28 bg-[oklch(0.25_0.040_130)]" id="習慣の意義">
      <div ref={ref} className="max-w-7xl mx-auto px-6">
        {/* ヘッダー */}
        <div className={`mb-20 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <span className="font-cormorant text-[oklch(0.72_0.1_130)] text-sm tracking-[0.3em] uppercase block mb-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-end">
            <div>
              <h2 className="font-mincho text-white text-3xl md:text-5xl font-bold leading-tight">
                髮のお悩みは、<br />
                <span className="text-[oklch(0.82_0.07_130)]">頭皮チェックから。</span>
              </h2>
            </div>
            <div>
              <p className="font-sans-jp text-white/80 text-sm leading-relaxed">
          ...
          <div className="mt-10 overflow-hidden rounded-sm" style={{ height: '220px' }}>
            ...
            />
              <div className="absolute inset-0 bg-gradient-to-r from-[oklch(0.25_0.040_130)/80] to-transparent pointer-events-none" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-0 border border-white/10">
          {values.map((v, i) => (
            ...
            >
              ...
              <div className="w-8 h-px bg-[oklch(0.69_0.060_130)/40] mb-4 group-hover:w-16 transition-all duration-500" />
        ...
        <div className={`mt-16 text-center transition-all duration-700 delay-500 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <a
            href="/booking"
            className="inline-block btn-gold-shimmer font-sans-jp text-[oklch(0.25_0.040_130)] text-sm font-bold px-10 py-4 rounded-sm tracking-wider"
          >
            無料スカルプチェックを予約する
          </a>
        </div>
    ...
    <section className="py-20 bg-[oklch(0.955_0.018_82)]">
      <div ref={ref} className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            >
              <div className="font-cormorant text-[oklch(0.30_0.045_130)] text-6xl md:text-7xl font-light mb-2">
                {stat.prefix}{stat.value}
                <span className="text-[oklch(0.69_0.060_130)] text-4xl">{stat.suffix}</span>
              </div>
              <p className="font-mincho text-[oklch(0.30_0.045_130)] text-base font-bold mb-1">{stat.label}</p>
              <p className="font-sans-jp text-[oklch(0.55_0.060_130)] text-xs">{stat.sub}</p>
            </div>
          ))}
        </div>
      </div>
...
function ServiceSection() {
  ...
  return (
    <section className="py-28 bg-[oklch(0.978_0.008_90)]" id="サービス">
      <div ref={ref} className="max-w-7xl mx-auto px-6">
        <div className={`text-center mb-16 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <span className="font-cormorant text-[oklch(0.69_0.060_130)] text-sm tracking-[0.3em] uppercase block mb-4">
            Our Services
          </span>
          <h2 className="font-mincho text-[oklch(0.30_0.045_130)] text-3xl md:text-4xl font-bold mb-4">
            3つのステップで、<br className="md:hidden" />頭皮の健康を守る
          </h2>
          <p className="font-sans-jp text-[oklch(0.55_0.060_130)] text-sm max-w-xl mx-auto">
          ...
          {services.map((svc, i) => (
            <div
              ...
              className={`relative rounded-sm overflow-hidden transition-all duration-700 ${
                svc.featured
                  ? "bg-[oklch(0.30_0.045_130)] shadow-2xl scale-105 z-10"
                  : "bg-white border border-[oklch(0.88_0.020_130)] hover:shadow-lg"
              } ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
              style={{ transitionDelay: `${i * 150}ms` }}
            >
              {svc.featured && (
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[oklch(0.42_0.055_130)] to-[oklch(0.82_0.045_130)]" />
              )}
              {svc.image && (
              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span
                    ...
                    style={{
                      ...
                      color: svc.featured ? "oklch(0.82_0.045_130)" : svc.color,
                    }}
                  >
                    {svc.badge}
                  </span>
                ...
                <h3
                  className={`font-mincho text-xl font-bold mb-1 ${
                    svc.featured ? "text-white" : "text-[oklch(0.30_0.045_130)]"
                  }`}
                >
                  {svc.title}
                </h3>
                <p
                  className={`font-sans-jp text-xs mb-6 ${
                    svc.featured ? "text-white/60" : "text-[oklch(0.55_0.060_130)]"
                  }`}
                >
                  {svc.subtitle}
                </p>
                <div className="flex items-baseline gap-2 mb-6">
                  ...
                  <span
                    className={`font-sans-jp text-xs ${
                      svc.featured ? "text-white/50" : "text-[oklch(0.55_0.060_130)]"
                    }`}
                  >
                    / {svc.time}
                  </span>
                    ...
                    <li key={j} className="flex items-start gap-3">
                      ...
                      <span
                        className={`font-sans-jp text-xs leading-relaxed ${
                          svc.featured ? "text-white/80" : "text-[oklch(0.40_0.055_130)]"
                        }`}
                      >
                        {item}
                      </span>
                ...
                <p
                  className={`font-sans-jp text-xs leading-relaxed border-t pt-6 ${
                    svc.featured
                      ...
                      : "text-[oklch(0.55_0.060_130)] border-[oklch(0.88_0.020_130)]"
                  }`}
                >
                  {svc.desc}
                </p>
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{ background: "radial-gradient(circle, oklch(0.69_0.060_130) 0%, transparent 70%)", transform: "translate(30%, -30%)" }}
        />
        <div
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className={`flex flex-col lg:flex-row gap-16 items-center mb-20 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className="flex-1">
            <span className="font-cormorant text-sm tracking-[0.4em] uppercase block mb-4" style={{ color: "oklch(0.72 0.1 130)" }}>
            ...
            <h2 className="font-mincho text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight" style={{ color: "#ffffff" }}>
              定期スカルプチェックは、<br />
              <span style={{ color: "oklch(0.72 0.1 130)" }}>頭皮リセットから始まる。</span>
            </h2>
    ...
    <section className="py-28 bg-[oklch(0.978_0.008_90)]">
      <div ref={ref} className="max-w-7xl mx-auto px-6">
        <div className={`text-center mb-16 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <h2 className="font-mincho text-[oklch(0.30_0.045_130)] text-3xl md:text-4xl font-bold">
            こんな方におすすめです
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {targets.map((t, i) => (
            <div
              key={i}
              className={`bg-white border border-[oklch(0.88_0.020_130)] rounded-sm p-5 md:p-8 hover:shadow-lg transition-all duration-500 ${
                inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <span className="font-sans-jp text-xs text-[oklch(0.55_0.060_130)] bg-[oklch(0.955_0.018_82)] px-2 py-0.5 rounded-full">
                      {t.age}
                    </span>
                    <span className="font-sans-jp text-xs text-[oklch(0.69_0.060_130)] font-medium">{t.segment}</span>
                  </div>
                  <h3 className="font-mincho text-[oklch(0.30_0.045_130)] text-lg font-bold mb-3">
                    「{t.message}」
                  </h3>
                  <p className="font-sans-jp text-[oklch(0.55_0.060_130)] text-sm leading-relaxed">{t.desc}</p>
                </div>
              </div>
            </div>
          ))}
...
function DigitalSection() {
  return (
    <section className="py-24 border-t border-[oklch(0.42_0.055_130)]/20" style={{ backgroundColor: "#162212" }}>
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          {/* Text */}
          <div>
            <p className="text-xs tracking-[0.3em] mb-4" style={{ color: "oklch(0.72 0.1 130)", fontFamily: "'Noto Sans JP', sans-serif" }}>MY SCALP KARTE</p>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 leading-tight" style={{ fontFamily: "'Shippori Mincho', serif", color: "#ffffff" }}>
              マイスカルプ<br />
              <span style={{ color: "oklch(0.72 0.1 130)" }}>カルテ</span>
            </h2>
            ...
            <ul className="space-y-3 mb-10">
              {[
                ...
                <li key={i} className="flex items-center gap-3 text-sm" style={{ fontFamily: "'Noto Sans JP', sans-serif", color: "rgba(255,255,255,0.85)" }}>
                  <span className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "oklch(0.42 0.055 130)", fontSize: "10px", color: "#ffffff", fontWeight: 700 }}>✓</span>
                  {item}
                </li>
              ))}
            </ul>
      ...
      <div ref={ref} className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-3">
          {faqs.map((faq, i) => (
            <div
              key={i}
              className={`border border-[oklch(0.88_0.020_130)] rounded-sm overflow-hidden transition-all duration-700 ${
            ...
            >
              ...
              >
              <span className="font-sans-jp text-[oklch(0.30_0.045_130)] font-bold" style={{fontSize: '17px'}}>
                {faq.q}
                </span>
                <span
                  className={`text-[oklch(0.69_0.060_130)] text-xl flex-shrink-0 transition-transform duration-300 ${
              ...
              {openIndex === i && (
                <div className="px-6 pb-6 bg-white border-t border-[oklch(0.88_0.020_130)]">
                  <p className="font-sans-jp text-[oklch(0.55_0.060_130)] text-sm leading-relaxed pt-4">
                    {faq.a}
                  </p>
                </div>
              )}
...
function TestimonialsSection() {
  ...
  return (
    <section className="py-28 bg-[oklch(0.30_0.045_130)]" id="お客様の声">
      <div ref={ref} className="max-w-7xl mx-auto px-6">
        <div className={`text-center mb-16 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <span className="font-cormorant text-[oklch(0.69_0.060_130)] text-sm tracking-[0.3em] uppercase block mb-4">
            Testimonials
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className={`bg-[oklch(0.30_0.045_130)] border border-white/10 rounded-sm p-5 md:p-7 transition-all duration-700 hover:border-[oklch(0.69_0.060_130)/40] hover:shadow-xl ${
                inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
              style={{ transitionDelay: `${i * 100}ms` }}
            >
              ...
              <div className="flex gap-1 mb-4">
                {Array.from({ length: 5 }).map((_, j) => (
                  <span
                    key={j}
                    className={`text-sm ${
                      j < t.rating ? "text-[oklch(0.69_0.060_130)]" : "text-white/20"
                    }`}
                  >
                    ★
                  </span>
              ...
              {/* ハイライト */}
              <p className="font-mincho text-[oklch(0.82_0.045_130)] text-sm font-bold mb-3 leading-snug">
                「{t.highlight}」
              </p>
              {/* 本文 */}
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-white/10">
                <div className="w-9 h-9 rounded-full bg-[oklch(0.69_0.060_130)/20] flex items-center justify-center flex-shrink-0">
                  <span className="font-cormorant text-[oklch(0.69_0.060_130)] text-sm font-semibold">
                    {t.name.charAt(0)}
                  </span>
                </div>
                <div>
    ...
    <section className="py-28 bg-[oklch(0.978_0.008_90)]" id="ビフォーアフター">
      <div ref={ref} className="max-w-7xl mx-auto px-6">
        ...
        <div className={`text-center mb-16 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="font-sans-jp text-[oklch(0.55_0.060_130)] text-sm">
        ...
        <div className={`transition-all duration-700 delay-200 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className="relative max-w-lg mx-auto mb-8">
            <div className="relative overflow-hidden rounded-sm shadow-2xl bg-[oklch(0.30_0.045_130)]">
              <img
              ...
              />
              {/* ラベル */}
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[oklch(0.22_0.035_130/90)] to-transparent px-6 py-5">
                <div className="flex items-end justify-between">
                  <div>
                    <span className="font-cormorant text-[oklch(0.69_0.060_130)] text-xs tracking-widest uppercase block mb-1">
                  ...
                  <div className="flex gap-2">
                    <span className="font-sans-jp text-[oklch(0.82_0.045_130)] text-xs bg-[oklch(0.69_0.060_130)/20] border border-[oklch(0.69_0.060_130)/40] px-3 py-1 rounded-full">
                      Before → After
                    </span>
                  </div>
                </div>
            ...
            <button
              ...
              className="absolute left-[-20px] top-1/2 -translate-y-1/2 w-10 h-10 bg-white shadow-lg rounded-full flex items-center justify-center text-[oklch(0.30_0.045_130)] hover:bg-[oklch(0.69_0.060_130)] hover:text-white transition-all"
              aria-label="前の画像"
            >
              ‹
            </button>
            <button
              ...
              className="absolute right-[-20px] top-1/2 -translate-y-1/2 w-10 h-10 bg-white shadow-lg rounded-full flex items-center justify-center text-[oklch(0.30_0.045_130)] hover:bg-[oklch(0.69_0.060_130)] hover:text-white transition-all"
              aria-label="次の画像"
            >
              ›
            </button>
          ...
          <div className="grid grid-cols-4 md:grid-cols-7 gap-2 max-w-2xl mx-auto">
            {BA_IMAGES.map((img, i) => (
              <button
                ...
                className={`relative overflow-hidden rounded-sm transition-all duration-300 ${
                  active === i
                    ? "ring-2 ring-[oklch(0.69_0.060_130)] ring-offset-2 opacity-100 scale-105"
            ...
            {BA_IMAGES.map((_, i) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all duration-300 ${
                  active === i ? "bg-[oklch(0.69_0.060_130)] w-6" : "bg-[oklch(0.69_0.060_130)/30]"
                }`}
                aria-label={`画像${i + 1}`}
              />
            ))}
          ...
          {/* 注意書き */}
          <p className="text-center font-sans-jp text-[oklch(0.55_0.060_130)] text-[11px] mt-6">
...
function ReservationSection() {
  ...
  const inputClass = (field: string) =>
    `w-full font-sans-jp text-sm bg-[oklch(0.30_0.045_130)] border ${
      errors[field]
        ? "border-red-400"
        : "border-white/15 focus:border-[oklch(0.69_0.060_130)]"
    } text-white placeholder-white/30 rounded-sm px-4 py-3 outline-none transition-colors`;

  return (
    <section className="py-28 bg-[oklch(0.25_0.040_130)]" id="予約">
      <div ref={ref} className="max-w-3xl mx-auto px-6">
        <div className={`text-center mb-14 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <span className="font-cormorant text-[oklch(0.69_0.060_130)] text-sm tracking-[0.3em] uppercase block mb-4">
            Reservation
        ...
        {submitted ? (
          <div className={`text-center py-16 transition-all duration-700 ${inView ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}>
            <div className="w-20 h-20 rounded-full bg-[oklch(0.69_0.060_130)/20] flex items-center justify-center mx-auto mb-6">
              <span className="text-[oklch(0.69_0.060_130)] text-3xl">✓</span>
            </div>
          ...
          >
            ...
            <div>
              <label className="font-sans-jp text-white/70 text-xs block mb-2">
                お名前 <span className="text-[oklch(0.69_0.060_130)]">*</span>
              </label>
              <input
                type="text"
                placeholder="山田 太郎"
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                <label className="font-sans-jp text-white/70 text-xs block mb-2">
                  電話番号 <span className="text-[oklch(0.69_0.060_130)]">*</span>
                </label>
                <input
                  type="tel"
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                <label className="font-sans-jp text-white/70 text-xs block mb-2">
                  ご希望日 <span className="text-[oklch(0.69_0.060_130)]">*</span>
                </label>
                <input
                  type="date"
              ...
              <div>
                <label className="font-sans-jp text-white/70 text-xs block mb-2">
                  ご希望時間 <span className="text-[oklch(0.69_0.060_130)]">*</span>
                </label>
                <select
                  value={form.time}
                ...
                >
                  ...
                  {timeSlots.map((t) => (
                    <option key={t} value={t} className="bg-[oklch(0.30_0.045_130)]">{t}</option>
                  ))}
                </select>
            ...
            <div>
              <label className="font-sans-jp text-white/70 text-xs block mb-3">
                ご希望コース <span className="text-[oklch(0.69_0.060_130)]">*</span>
              </label>
                ...
                {[
                  ...
                  <button
                    ...
                    className={`text-left p-4 rounded-sm border transition-all ${
                      form.plan === opt.value
                        ? "border-[oklch(0.69_0.060_130)] bg-[oklch(0.69_0.060_130)/15]"
                        : "border-white/15 bg-[oklch(0.30_0.045_130)] hover:border-white/30"
                    }`}
                  >
                    <p className={`font-mincho text-xs font-bold mb-1 ${
                      form.plan === opt.value ? "text-[oklch(0.82_0.045_130)]" : "text-white"
                    }`}>{opt.label}</p>
            ...
            <div className="flex items-start gap-3">
              <input type="checkbox" id="privacy" required className="mt-1 accent-[oklch(0.69_0.060_130)]" />
              <label htmlFor="privacy" className="font-sans-jp text-white/50 text-xs leading-relaxed">
                <a href="/privacy" target="_blank" className="text-[oklch(0.69_0.060_130)] underline hover:text-[oklch(0.82_0.10_75)]">プライバシーポリシー</a>に同意の上、送信します。
              </label>
            </div>
    ...
    <section className="py-28 bg-[oklch(0.978_0.008_90)]" id="店舗情報">
      <div ref={ref} className="max-w-7xl mx-auto px-6">
        ...
        <div className={`text-center mb-16 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="font-sans-jp text-[oklch(0.42_0.055_130)] text-sm max-w-xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {stores.map((store, i) => (
            <div
              key={store.id}
              className={`bg-white border border-[oklch(0.88_0.020_130)] rounded-sm overflow-hidden shadow-sm hover:shadow-md transition-all duration-500 ${
                inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
              style={{ transitionDelay: `${i * 150}ms` }}
            >
              ...
              <div className="p-7">
                <div className="mb-5">
                  <p className="font-cormorant text-[oklch(0.69_0.060_130)] text-xs tracking-widest uppercase mb-1">
                    {store.nameEn}
                  </p>
                  <h3 className="font-mincho text-[oklch(0.30_0.045_130)] text-xl font-bold">
                    {store.name}
                  </h3>
                </div>
                ...
                <div className="flex items-start gap-3 mb-4">
                  <span className="text-[oklch(0.69_0.060_130)] text-base mt-0.5 flex-shrink-0"></span>
                  <div className="font-sans-jp text-[oklch(0.40_0.055_130)] text-sm leading-relaxed">
                    <p>{store.address}</p>
                  ...
                  <div>
                    {store.hours.map((h) => (
                      <div key={h.day} className="flex gap-3 mb-1">
                        <span className="font-sans-jp text-[oklch(0.55_0.060_130)] text-xs w-20 flex-shrink-0">{h.day}</span>
                        <span className="font-sans-jp text-[oklch(0.30_0.045_130)] text-xs font-medium">{h.time}</span>
                      </div>
                    ))}
                    <p className="font-sans-jp text-[oklch(0.55_0.060_130)] text-xs mt-1">定休日：{store.closed}</p>
                  </div>
                </div>

                {/* 施術メニュー */}
                <div className="mb-6">
                  <p className="font-sans-jp text-[oklch(0.55_0.060_130)] text-xs mb-2 tracking-wider">主な施術メニュー</p>
        ...
        {false && <div className={`mt-16 bg-[oklch(0.30_0.045_130)] rounded-sm p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6 transition-all duration-700 delay-300 ${
          inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
        }`}>
          <div>
            <p className="font-cormorant text-[oklch(0.69_0.060_130)] text-xs tracking-[0.3em] uppercase mb-2">For Salon Partners</p>
          ...
          <a
            href="/salon"
            className="flex-shrink-0 border border-[oklch(0.69_0.060_130)] text-[oklch(0.69_0.060_130)] font-sans-jp font-medium text-sm px-8 py-3.5 rounded-sm hover:bg-[oklch(0.69_0.060_130)] hover:text-[oklch(0.25_0.040_130)] transition-all duration-300 whitespace-nowrap"
          >
            認定サロン募集ページへ →
          </a>
        </div>}
...
function CtaSection() {
  const { ref, inView } = useInView();
  return (
    <section className="py-28 bg-[oklch(0.25_0.040_130)] relative overflow-hidden" id="cta">
      ...
      <div ref={ref} className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        <div className={`transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <span className="font-cormorant text-[oklch(0.69_0.060_130)] text-sm tracking-[0.3em] uppercase block mb-6">
            Start Your Journey
          </span>
          <h2 className="font-mincho text-white text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
            まずは<span className="text-[oklch(0.82_0.045_130)]">無料</span>で<br />
            頭皮の今を知ることから。
          </h2>
    ...
    <footer className="bg-[oklch(0.12_0.04_140)] py-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-white/10 pt-8 mb-6">
          ...
          <p className="font-sans-jp text-white/35 text-[10px] text-center">設立：昭和61年4月24日｜化粧品製造業・化粧品製造販売業｜直営店：神戸阪急本館６階 / THE HERBSサロン / 植物美容学校</p>
        </div>
        {/* 免責事項 */}
        <div className="border-t border-white/10 pt-8 mb-6">
