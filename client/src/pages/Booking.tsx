    ...
    <div style={{ minHeight: "100dvh", background: "oklch(0.978 0.008 90)", fontFamily: "'Noto Sans JP', sans-serif" }}>
      ...
      <main style={{ maxWidth: "600px", margin: "0 auto", padding: "2.5rem 1rem 5rem" }}>
        ...
        <div style={{ background: "oklch(0.98 0.018 75)", border: "1px solid oklch(0.88 0.04 70)", borderRadius: "6px", padding: "1.25rem 1.5rem", marginBottom: "2rem" }}>
          <p style={{ fontSize: "0.72rem", letterSpacing: "0.15em", color: "oklch(0.69 0.060 130)", marginBottom: "0.75rem", fontWeight: 600 }}>
            ご予約に関するご注意
          </p>
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.5rem" }}>
            {[
              ...
              <li key={i} style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.82rem", color: "oklch(0.4 0.04 42)", lineHeight: 1.7 }}>
                <span style={{ color: "oklch(0.69 0.060 130)", fontWeight: 700, flexShrink: 0, marginTop: "0.1rem" }}>・</span>
                {note}
              </li>
            ))}
          </ul>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
            {STORES.map((s) => (
              ...
              >
                ...
                <p style={{ fontSize: "0.72rem", color: "oklch(0.55 0.060 130)", lineHeight: 1.5 }}>
                  {s.address}
                </p>
                {"hours" in s && s.hours && (
        ...
        {selectedStore === "salon" && (
          <div style={{ background: "white", borderRadius: "8px", boxShadow: "0 2px 16px rgba(0,0,0,0.06)", padding: "2rem 1.5rem", marginBottom: "2rem", textAlign: "center" }}>
            <div style={{ width: "56px", height: "56px", borderRadius: "50%", background: "oklch(0.97 0.025 75)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 1.25rem" }}>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="oklch(0.69 0.060 130)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a
              ...
              style={{
                ...
                gap: "0.5rem",
                padding: "0.9rem 2rem",
                background: "oklch(0.42 0.055 130)",
                color: "white",
                textDecoration: "none",
                borderRadius: "4px",
                fontWeight: 700,
