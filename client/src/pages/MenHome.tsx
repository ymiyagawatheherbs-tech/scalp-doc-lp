          ...
          <Link href="/men" className="flex items-center gap-2.5 flex-shrink-0">
            ...
            <div className="flex flex-col leading-none">
              <span
                ...
                style={{ fontFamily: "'Noto Sans JP', sans-serif", fontSize: "1rem", fontWeight: 700, color: "rgba(255,255,255,0.95)", letterSpacing: "0.12em" }}
              >
                スカルプラボ
              </span>
              <span
        ...
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            <button
              ...
              className="px-6 md:px-8 py-3.5 md:py-4 bg-[oklch(0.69 0.060 130)] text-white font-bold tracking-widest text-sm hover:bg-[oklch(0.72 0.1 130)] transition-all duration-300 flex items-center justify-center gap-2 font-['Noto_Sans_JP']" style={{textShadow: '0 1px 3px rgba(0,0,0,0.5)'}}
            >
              無料チェックを予約する
              <ArrowRight size={16} />
            </button>
